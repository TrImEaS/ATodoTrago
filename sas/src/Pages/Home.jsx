     ...
     {/*Banner*/}
      <section id="banner" className="flex justify-center items-center bg-[#f3f3f3] w-full h-[600px] ">
        <article className="w-3/4 flex flex-col justify-center h-full gap-4">
          <span className="text-6xl text-pink-500 font-bold bg-black w-[320px] text-center rounded-xl p-1">
            Bienvenido
          </span>
          <p className="text-2xl bg-black text-pink-300 w-[280px] rounded-xl text-center p-1">
            Descubre nuestros tragos
          </p>
          <NavLink
            className={'flex justify-center items-center gap-2 border-2 w-[140px] h-12 rounded-lg hover:bg-white bg-black hover:text-black hover:text-lg duration-300'} 
            to={'/tragos'}>
            <span>Bebidas</span>
